...
async def forgot_password(payload: ForgotPasswordRequest):
    """Gửi SMS chứa OTP để lấy lại mật khẩu."""
    pass

@auth_router.post("/reset-password", status_code=status.HTTP_200_OK)
async def reset_password(payload: ResetPasswordRequest):
    """Đặt lại mật khẩu sử dụng token đã cấp."""
    pass
```
...
*   **Quy tắc gửi SMS**:
    ...
    2.  **Logic**:
        ...
        -   Đối với `forgot-password`, Server sinh mã OTP, lưu vào Redis/DB với thời hạn ngắn và gửi qua SMS.
